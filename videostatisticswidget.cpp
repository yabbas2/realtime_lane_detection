...
void Widget::setExecTimePerFrameValue(QString value)
{
    ExecTimePerFrameValue->setText(value + " msec/frame");
}

void Widget::setAvgExecTimePerFrameValue(QString value)
{
    ExecTimePerFrameValue->setText(value + " msec/frame");
}

void Widget::setAvgFramePerSecValue(QString value)
{
